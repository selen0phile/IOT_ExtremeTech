...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-red-50">
            ...
            <div className="space-y-6">
              <div className="inline-block px-4 py-2 bg-purple-100 rounded-full">
                <span className="text-purple-700 font-semibold text-sm">
                  🎯 IoT Innovation Challenge Winner
                </span>
              </div>
              <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                <span className="bg-gradient-to-r from-red-500 via-purple-600 to-violet-600 bg-clip-text text-transparent">
                  Smart Rickshaw
                </span>
                <br />
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  onClick={() => navigate("/")}
                  className="bg-gradient-to-r from-red-500 to-purple-600 hover:from-red-600 hover:to-purple-700 text-white text-lg px-8 py-6 h-auto"
                >
                  Try Live Demo
              ...
              <div className="flex items-center gap-8 pt-4">
                ...
                <div>
                  <div className="text-3xl font-bold text-violet-600">IoT</div>
                  <div className="text-sm text-gray-600">Powered</div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-red-500/20 to-purple-600/20 rounded-3xl blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              making it difficult for passengers to find available rickshaws and
              for drivers to optimize their routes efficiently.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200">
              ...
              <p className="text-gray-600">
                Cash-only transactions create inconvenience and safety concerns
                for both passengers and drivers.
              </p>
            </div>

            <div className="p-6 rounded-2xl bg-gradient-to-br from-violet-50 to-violet-100 border border-violet-200">
              ...
              <p className="text-gray-600">
                No efficient system for passengers to request rides and drivers
                to receive booking notifications instantly.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A comprehensive smart system integrating hardware sensors, mobile
              app, and cloud infrastructure
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600 text-sm">
                User-friendly interface for requesting rides, tracking location,
            ...
            <div className="p-6 rounded-2xl bg-white shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              <div className="w-12 h-12 bg-gradient-to-br from-red-600 to-purple-600 rounded-xl flex items-center justify-center mb-4">
      ...
      <section
        id="documentation"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 to-purple-50"
      >
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">
          ...
          <div className="mb-12 bg-white rounded-3xl shadow-xl p-8 border border-gray-200">
            ...
            <div className="space-y-6">
              <div className="border-2 border-gray-200 rounded-xl p-6 bg-white shadow-sm">
                <p className="text-gray-800 font-semibold mb-3 text-center">System Architecture Diagram</p>
                <p className="text-sm text-gray-500 mb-4 text-center">
                  Complete System Overview: ESP32, WebSocket, Firebase & React Frontend
                </p>
                <div className="bg-gray-50 rounded-lg p-4">
                  <img
                    src="/system.png"
              ...
              <div className="border-2 border-purple-200 rounded-xl p-6 bg-white shadow-sm">
                ...
                <p className="text-sm text-gray-500 mb-4 text-center">
                  Complete interaction flow: User → WebSocket → Firebase → ESP32
                </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-200">
            ...
            <div className="space-y-6">
              <div className="border-2 border-violet-200 rounded-xl p-6 bg-white shadow-sm">
                ...
                <div className="mt-4 bg-gray-50 rounded-lg p-4">
                  <p className="text-sm font-semibold text-gray-800 mb-2">Video Coverage:</p>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-red-500 via-purple-600 to-violet-600">
